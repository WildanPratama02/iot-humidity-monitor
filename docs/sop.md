...
- WAH PACKAGING: `https://docs.google.com/spreadsheets/d/1daMT_gUX6xxE3gRDrugW_aqInn328e0I7iM2nHyl3xs/edit?usp=sharing`
...
1.  **Layout Grid:**
    - Atas: 2 Kolom untuk QR Code & Button.
        - **Kiri:** QR Action Plan + Button "CLICK HERE TO ACTION PLAN" (Bg Navy blue).
        - **Kanan:** QR Summary + Button "CLICK HERE TO SUMMARY ACTION PLAN" (Bg sea Bue).
